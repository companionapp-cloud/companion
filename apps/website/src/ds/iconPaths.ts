...
export const ICON_PATHS = {
  ...
  // Glyphs added with the app's dense redesign, copied from packages/design-system so the
  // landing-page mockups draw the same chrome (quick capture, the theme toggle, menus).
  ...
  // The two ways to sync, on the pricing page: our cloud, or a server you run.
