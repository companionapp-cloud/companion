 ...
 *  (PLAN §7). Extracted from the old settings modal so it can render as a settings page
  ...
  return (
    <View style={{ gap: space.lg }}>
      ...
      <Text tone="tertiary" variant="caption">
        Point web, desktop, and mobile at the same server + account to sync everything.
      </Text>
    </View>
  );
}
