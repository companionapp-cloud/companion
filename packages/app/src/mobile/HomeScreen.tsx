...
type SectionView = Extract<ViewId, "today" | "chat" | "notes" | "tasks" | "canvases" | "notebooks" | "habits" | "calendar" | "graph" | "logbook" | "trash">;
const SECTIONS: { view: SectionView; label: string; subtitle: string; icon: IconName; accent?: boolean }[] = [
  ...
  { view: "notebooks", label: "Notebooks", subtitle: "Paper pages for writing and drawing", icon: "notebook" },
